...
export default function ProjectDetailPage() {
    ...
    try {
      ...
      if (pResp.status === 'fulfilled' && pResp.value.success) {
        ...
        const mapped = {
          ...
          pv_inverter_model: raw.lead_pv_inverter_model ?? raw.pv_inverter_model,
          pv_inverter_series: raw.lead_pv_inverter_series ?? raw.pv_inverter_series,
          pv_inverter_power_kw: raw.lead_pv_inverter_power_kw ?? raw.pv_inverter_power_kw,
          pv_inverter_quantity: raw.lead_pv_inverter_quantity ?? raw.pv_inverter_quantity,
          pv_panel_brand: raw.lead_pv_panel_brand ?? raw.pv_panel_brand,
          pv_panel_model: raw.lead_pv_panel_model ?? raw.pv_panel_model,
          pv_panel_quantity: raw.lead_pv_panel_quantity ?? raw.pv_panel_quantity,
  ...
  const handleSaveInHouseDetails = async (form) => {
    ...
    const leadPayload = {
      ...
      pv_inverter_model: form.pv_inverter_model || null,
      pv_inverter_series: form.pv_inverter_series || null,
      pv_inverter_power_kw: numOrNull(form.pv_inverter_power_kw),
      pv_inverter_quantity: numOrNull(form.pv_inverter_quantity),
      pv_panel_brand: form.pv_panel_brand || null,
      pv_panel_model: form.pv_panel_model || null,
      pv_panel_quantity: numOrNull(form.pv_panel_quantity),
