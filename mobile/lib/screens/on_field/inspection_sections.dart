...
final List<InspectionSection> inspectionSections = [
  ...
  InspectionSection(
    ...
    fields: [
      ...
      InspectionField(key: 'roofProfile.section2Pitch', label: 'Section 2 pitch', type: InspectionFieldType.text),
      InspectionField(key: 'roofProfile.section2Photo', label: 'Section 2 Photo', type: InspectionFieldType.photo),
      InspectionField(key: 'roofProfile.section3Pitch', label: 'Section 3 pitch', type: InspectionFieldType.text),
