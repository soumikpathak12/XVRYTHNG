...
export async function getProjects(filters = {}) {
  ...
  const sql = `
    SELECT
      ...
      l.pv_inverter_model AS lead_pv_inverter_model,
      l.pv_inverter_series AS lead_pv_inverter_series,
      l.pv_inverter_power_kw AS lead_pv_inverter_power_kw,
      l.pv_inverter_quantity AS lead_pv_inverter_quantity,
      l.pv_panel_brand AS lead_pv_panel_brand,
      l.pv_panel_model AS lead_pv_panel_model,
      l.pv_panel_quantity AS lead_pv_panel_quantity,
